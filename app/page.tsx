...
import { Settings as SettingsIcon, Shield, Mic, Cpu, Monitor, Zap } from 'lucide-react'
...
export default function Home() {
  ...
  // Register window listeners for Electron
  useEffect(() => {
    if (typeof window !== 'undefined' && (window as any).require) {
      const { ipcRenderer } = (window as any).require('electron')

      const handleToggleVoice = () => setActiveTab('voice')
  ...
  // Auto-send transcript when finished speaking if enabled
  useEffect(() => {
  ...
  return (
    <main className="h-screen w-screen overflow-hidden">
      <FloatingWindow title={`Nova AI / Stealth / ${settings.freeMode ? 'Free Mode' : 'Premium'}`}>
